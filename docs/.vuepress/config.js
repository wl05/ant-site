    ...
    sidebar: {
      '/tech/': [
        ...
        },
        {
          title: 'Typescript',
          collapsable: false,
          children: ['typescript/basic-type/', 'typescript/type-manipulation/generics.md', 'typescript/function/']
        },
        {
          title: '浏览器',
          collapsable: false,
        ...
        },
        {
          title: 'git',
          collapsable: false,
          children: ['git/git-base.md', 'git/git-rebase/', 'git/git-config.md', 'git/guide-to-contributing-on-github/']
        },
        {
          title: '算法',
          collapsable: false,
