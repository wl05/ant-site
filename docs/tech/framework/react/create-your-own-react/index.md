...
读完整篇文章可以对 react 基本原理有一个整体上的认识和宏观上的把握，对于进一步学习 react 源码非常有帮助。
...
在开始学习之前我们需要对 react 的整体架构有一个清晰的认识，把涉及到的概念在架构上进行划分，了解架构中每一部分的职责这样我们才能做到心中有数

不会迷失在繁琐的细节中。闲话少说我们先来一起看看 react 的整体架构。 
